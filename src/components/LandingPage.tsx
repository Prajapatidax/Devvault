...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return (
    <div className={`w-full overflow-x-hidden overflow-y-auto bg-zinc-50 dark:bg-zinc-950 text-zinc-800 dark:text-zinc-150 font-sans transition-colors duration-300 relative ${isWorkspaceView ? "h-full rounded-2xl border border-zinc-200 dark:border-zinc-800/80 p-4 md:p-6 bg-white dark:bg-zinc-950/40 backdrop-blur-md" : "min-h-screen"}`}>
